...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-signup2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
	    	...
	    	<div class="card mb-0">
	    		<div class="card-body">
	    			<div class="card-content p-3">
					 <div class="card-title text-uppercase text-center pb-3">Sign Up</div>
					    <form>
						 ...
						 <button type="button" class="btn btn-primary shadow-primary btn-block waves-effect waves-light">Sign Up</button>
						 ...
						 <hr>
						 <p class="text-muted">Already have an account? <a href="authentication-signin2.php"> Sign In here</a></p>
						 </div>
					</form>
				 </div>
				</div>
