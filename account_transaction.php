...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <h6 class="text-uppercase">Add New Account</h6>
     <hr>
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
            <form method="post" action="account_inserts.php" onsubmit="myFunction()">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="input-6">Select Account</label>
                   <select name="dept_name" class="form-control form-control-square" id="input-23">
                      <option>SELECT</option>
                       <?php include('include/config.php'); ?>
                       <?php 
                      $sqli = "SELECT * FROM accounts";
                      $result = mysqli_query($con, $sqli);
                       while ($row = mysqli_fetch_array($result)) {
                          # code...
                        echo '<option >'.$row['account_name'].'-'.$row['account_id'].'</option>';
                       }  
                      ?>
                   </select>
                  </div>
                  <div class="form-group col-md-6">
                <!----    <label for="input-7">Cash Debit/Credit</label>
                   <select name="dept_name" class="form-control form-control-square" id="input-23">
                      <option>SELECT</option>
                       <?php include('include/config.php'); ?>
                       <?php 
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="input-3">Select Date</label>
                    <input type="date" class="form-control" id="input-3" name="finance"  required=""     placeholder="Amount inter here">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="input-4">Details</label>
                    <input type="text" class="form-control" id="input-4" name="mobile"          placeholder="Mobile No inter">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="input-3">Enter Amount</label>
				  ...
				  <tbody>
                    ...
                    <tr> 
                      ...
                      echo "<td>".$row['account_name']."</td>";
                       "<td><a href=\"department_update.php?id=$row[0]\">Edit</a> | <a href=\"department_delete.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";   
                    }
                    ?>
                  </tr>
					</tbody>
