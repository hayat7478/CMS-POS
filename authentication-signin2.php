...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-signin2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
					   ...
					   <form>
						  ...
						  <div class="form-group col-6">
							...
							<div class="form-group col-6 text-right">
							 <a href="authentication-reset-password2.php">Reset Password</a>
							</div>
						</div>
						<button type="button" class="btn btn-primary shadow-primary btn-block waves-effect waves-light">Sign In</button>
						...
						<a href="javascript:void()" class="btn-social-text btn-google-plus waves-effect waves-light m-1"><i class="fa fa-google-plus"></i> <span>google+</span></a>
							<hr>
						<p class="text-muted">Do not have an account? <a href="authentication-signup2.php"> Sign Up here</a></p>
						</div>
					</form>
				 </div>
				</div>
