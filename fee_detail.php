...
$result = mysqli_query($mysqli, "SELECT * FROM fee ORDER BY id DESC"); // using mysqli_query instead
?>
...
<!-- Mirrored from kvthemes.com/bangodash/color-version/table-data-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:46:02 GMT -->
<head>
  <meta charset="utf-8"/>
...
<div class="clearfix"></div>
  ...
  while($res = mysqli_fetch_array($result)) {     
    ...
    echo "<td>".$res['challan_no']."</td>";
    echo "<td>".$res['charges']."</td>";
    echo "<td>".$res['total_amount']."</td>";
    echo "<td>".$res['bank']."</td>";
    echo "<td>".$res['br_cod']."</td>";
    echo "<td>".$res['agent_name']."</td>";
    echo "<td>".$res['location']."</td>";
    echo "<td>".$res['status']."</td>";
    echo "<td>".$res['submit_no']."</td>";
    echo "<td>".$res['date']."</td>";
    echo "<td>".$res['time_date']."</td>";
    echo "<td><a href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"fee_delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
       echo "</tr>";   
  }
  ?>
                    </tr>
...
<!-- Mirrored from kvthemes.com/bangodash/color-version/table-data-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:48:55 GMT -->
</html>
