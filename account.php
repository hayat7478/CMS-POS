     ...
     <hr>
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
            <form method="post" action="account_insert.php" onsubmit="myFunction()">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="input-1" name="account_id" required="">
					        </div>
                  <div class="form-group col-md-6">
                    <label for="input-1">Account Name</label>
                    <input type="text" class="form-control" id="input-1" name="account_name" required="">
                  </div>
                </div>
