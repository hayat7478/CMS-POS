...
?>
             <form method="post" action="etoken_edit.php">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="name" value="<?php echo $name;?>"  id="input-1" >
                  </div>

                  <div class="form-group col-md-6">
                    <label for="input-2">CNIC No/Form Number</label>
                    <input type="Number" class="form-control" id="input-2" name="formno" value="<?php echo $formno;?>" placeholder="Number inter here">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="input-3">Paid Amount</label>
                    <input type="Number" class="form-control" id="input-3" name="finance" value="<?php echo $finance;?>" required=""     placeholder="Amount inter here">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="input-4">Contact Number</label>
                    <input type="Number" class="form-control" id="input-4" name="mobile" value="<?php echo $mobile;?>"         placeholder="Mobile No inter">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="input-6">Services</label>
                  <select class="form-control" id="input-6" name="service" value="<?php echo $service;?>">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="input-7" name="in_out"  value="<?php echo $in_out;?>"   >
                      <option>IN</option>
                      <option>OUT</option>
                  </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" id="input-9" name="textarea" value="<?php echo $textarea;?>" >
                  </textarea>
                    <input type="hidden" name="id" value=<?php echo $_GET['id'];?>>
                </div>
                <div class="form-footer">
                <button type="submit" class="btn btn-dark shadow-dark m-1"><i class="fa fa-times"></i> Cancel</button>
                 <button input type="submit" name="update" value="Update" class="btn btn-success shadow-success m-1">UPDATE RECORD</button>
                </div>
              </form>
            </div>
          </div>
...
<div class="col-lg-6">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <?php
				$result = mysqli_query($conn,"SELECT * FROM etoken ORDER BY id DESC LIMIT 10;");    
          ...
          <a href="javascript:void();"><i aria-hidden="true" class="fa fa-edit"></i> <span class="sr-only">Example of</span> edit</a>
          </td>
