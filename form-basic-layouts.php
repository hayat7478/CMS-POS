...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <h6 class="text-uppercase">Basic form layout</h6>
     <hr>
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <form>
                ...
                <div class="form-group">
                  <label for="input-5">Organization Name</label>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="input-7">Budget</label>
                ...
                <div class="form-group">
                  <label for="input-8">Select File</label>
                  <input type="file" class="form-control" id="input-8">
                </div>
                <div class="form-group">
                  <label for="input-9">Project Information</label>
          ...
          <div class="card">
            <div class="card-body">
              <form>
                ...
                <div class="form-group">
                  <label for="input-15">Website Url</label>
                  <input type="text" class="form-control" id="input-15">
                </div>
                <div class="form-group">
                  <label for="input-16">Contact Number</label>
                  <input type="text" class="form-control" id="input-16">
                </div>
                <div class="form-group">
                  <label for="input-17">User Information</label>
