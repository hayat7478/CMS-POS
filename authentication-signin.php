...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-signin.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
			...
			<div class="form-row mr-0 ml-0">
			 ...
			 <button type="button" class="btn btn-primary btn-round btn-block waves-effect waves-light">Sign In</button>
			  <div class="text-center pt-3">
				...
				<hr>
				<p class="text-muted">Do not have an account? <a href="authentication-signup.php"> Sign Up here</a></p>
			  </div>
			 </form>
		   </div>
		  </div>
