      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
<!-----------------=========FORM STARTING===============------------->
              <form method="post" action="account_filter_statement.php">
                <h4 class="form-header text-uppercase">
                 ...
                 <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <select name="id_account" class="form-control form-control-square" id="input-23">
                      <option>SELECT</option>
                       <?php include('include/config.php'); ?>
                       <?php 
                      $sqli = "SELECT * FROM bank";
                      $result = mysqli_query($con, $sqli);
                       while ($row = mysqli_fetch_array($result)) {
                          # code...
                        echo '<option >'.$row['id_account'].'</option>';
               ...
               <!------- <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" name="class_name" id="input-1" name="class_id" required="">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
