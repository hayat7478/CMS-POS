...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-reset-password2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
			 ...
			 <div class="card-title text-uppercase text-center pb-3">Reset Password</div>
			  <p class="text-center pb-2">Please enter your email address. You will receive a link to create a new password via email.</p>
			    <form>
				 ...
				 <button type="button" class="btn btn-primary shadow-primary btn-block waves-effect waves-light mt-3">Reset Password</button>
				 <div class="clearfix"></div>
				  <div class="text-center pt-3">
					<hr>
					<p class="text-muted">Return to the <a href="authentication-signin2.php"> Sign In</a></p>
				  </div>
				 </form>
			   </div>
			  </div>
