...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-reset-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
		    ...
		    <form>
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input type="text" id="exampleInputEmailAddress" class="form-control form-control-rounded" placeholder="Email Address">
			  ...
			  <div class="text-center pt-3">
				<hr>
				<p class="text-muted">Return to the <a href="authentication-signin.php"> Sign In</a></p>
			  </div>
			 </form>
		   </div>
		  </div>
