...
<!-- Mirrored from kvthemes.com/bangodash/color-version/authentication-signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Oct 2019 08:49:52 GMT -->
<head>
  <meta charset="utf-8"/>
		    ...
		    <form>
			 ...
			 <button type="button" class="btn btn-primary btn-round btn-block waves-effect waves-light">Sign Up</button>
			  <div class="text-center pt-3">
				...
				<hr>
				<p class="text-muted">Already have an account? <a href="authentication-signin.php"> Sign In here</a></p>
			  </div>
			 </form>
		   </div>
		  </div>
